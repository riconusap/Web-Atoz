...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        if ($del) {
			...
			unlink($delPath);
            echo '<script>alert("Berhasil menghapus data."); document.location="index.php?page=inbox_proposal";</script>';
        } else {
            echo '<script>alert("Gagal menghapus data."); document.location="index.php?page=inbox_proposal";</script>';
        }
    } else {
